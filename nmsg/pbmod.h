...
/*%<
 * Module function type for freeing resources associated with a pbuf. This
 * function will be called after a pbuf generated by a call to an
 * nmsg_pbmod_pres2pbuf_fp function is no longer needed.
 *
 * Ensures:
 *
 * \li	'pbuf' is a pointer to a pbuf generated by the module.
 */

typedef void (*nmsg_pbmod_free_pres_fp)(void *clos, char **pres);
/*%<
 * Module function type for freeing resources associated with presentation
 * format output. This function will be called after a string generated by
 * a call to an nmsg_pbmod_pbuf2pres_fp function is no longer needed.
 *
 * Ensures:
 *
 * \li	'clos' is the opaque pointer returned by the initialization
 *	function.
 *
 * \li	'pres' is a pointer to a presentation format string generated by
 *	 the module.
 */
...
nmsg_res
nmsg_pbmod_free_pbuf(nmsg_pbmod mod, uint8_t **pbuf);
/*%<
 * Free resources allocated by a call to nmsg_pbmod_pres2pbuf().
 *
 * Requires:
 *
 * \li	'mod' is an initialized pbmod.
 *
 * \li	'pbuf' is a pointer to a serialized payload generated by the module
 *	 instance identified by 'mod' and 'clos'.
 *
 * Ensures:
 *
 *	'*pbuf' will be NULL on return.
 *
 * Returns:
 *
 * \li	nmsg_res_success
...
nmsg_res
nmsg_pbmod_free_pres(nmsg_pbmod mod, void *clos, char **pres);
/*%<
 * Free resources allocated by a call to nmsg_pbmod_pbuf2pres().
 *
 * Requires:
 *
 * \li	'mod' is an initialized pbmod.
 ...
 *	 function.
 *
 * \li	'pres' is a pointer to the presentation format string generated by
 *	the module instance identified by 'mod' and 'clos'.
 *
 * Ensures:
 *
 * \li	'*pres' will be NULL on return.
 *
 * Returns:
 *
 * \li	nmsg_res_success
