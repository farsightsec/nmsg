...
if test x_$withval = x_no; then
    ...
    libprotobuf_c_ldadd="$srcdir/dep/protobuf-c/libnmsg_protobuf-c.la"
fi
...
if test x_$withval = x_yes; then
    ...
    libprotobuf_c_ldadd="-lprotobuf-c"
