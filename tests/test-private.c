...
/* a2_response is a binary value generated from the base64 encoding of q2.message.response,
 * and it is assigned to the "response" field of a2. */
...
/* a3_query_packet is a binary value generated from the base64 encoding of q3.message.query_packet,
 * and it is assigned to the "query_packet" field of a3. */
...
/* a3_query is a binary value generated from the base64 encoding of q3.message.query,
 * and it is assigned to the "query" field of a3. */
...
/* a3_query_time_sec is a binary value generated from the base64 encoding of q3.message.query_time_sec,
 * and it is assigned to the "query_time_sec" field of a3. */
const char a3_query_time_sec[] = {0x8e,0x04,0x50,0x64,0x00,0x00,0x00,0x00};
/* a3_query_time_nsec is a binary value generated from the base64 encoding of q3.message.query_time_nsec,
 * and it is assigned to the "query_time_nsec" field of a3. */
